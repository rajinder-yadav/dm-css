describe("Border Style-Notation", () => {
  ...
  context("Borders size all sides", () => {
    it("None", () => {
      cy
        .get("#b0")
  ...
  context("Borders size top", () => {

    it("Border top size 1px", () => {
      cy.get("#bt0").should("have.css", "border-top-width", "0px");
    });
    it("Border top size 1px", () => {
      cy.get("#bt1").should("have.css", "border-top-width", "1px");
    });
    it("Border top size 2px", () => {
      cy.get("#bt2").should("have.css", "border-top-width", "2px");
    });
    it("Border top size 3px", () => {
      cy.get("#bt3").should("have.css", "border-top-width", "3px");
    });
    it("Border top size 4px", () => {
      cy.get("#bt4").should("have.css", "border-top-width", "4px");
    });
  });

  context("Borders size bottom", () => {

    it("Border bottom size 1px", () => {
      cy.get("#bb0").should("have.css", "border-bottom-width", "0px");
    });
    it("Border bottom size 1px", () => {
      cy.get("#bb1").should("have.css", "border-bottom-width", "1px");
    });
    it("Border bottom size 2px", () => {
      cy.get("#bb2").should("have.css", "border-bottom-width", "2px");
    });
    it("Border bottom size 3px", () => {
      cy.get("#bb3").should("have.css", "border-bottom-width", "3px");
    });
    it("Border bottom size 4px", () => {
      cy.get("#bb4").should("have.css", "border-bottom-width", "4px");
    });
  });

  context("Borders size left", () => {

    it("Border left size 1px", () => {
      cy.get("#bl0").should("have.css", "border-left-width", "0px");
    });
    it("Border left size 1px", () => {
      cy.get("#bl1").should("have.css", "border-left-width", "1px");
    });
    it("Border left size 2px", () => {
      cy.get("#bl2").should("have.css", "border-left-width", "2px");
    });
    it("Border left size 3px", () => {
      cy.get("#bl3").should("have.css", "border-left-width", "3px");
    });
    it("Border left size 4px", () => {
      cy.get("#bl4").should("have.css", "border-left-width", "4px");
    });
  });

  context("Borders size right", () => {

    it("Border right size 1px", () => {
      cy.get("#br0").should("have.css", "border-right-width", "0px");
    });
    it("Border right size 1px", () => {
      cy.get("#br1").should("have.css", "border-right-width", "1px");
    });
    it("Border right size 2px", () => {
      cy.get("#br2").should("have.css", "border-right-width", "2px");
    });
    it("Border right size 3px", () => {
      cy.get("#br3").should("have.css", "border-right-width", "3px");
    });
    it("Border right size 4px", () => {
      cy.get("#br4").should("have.css", "border-right-width", "4px");
    });
  });

  context("Borders size faces", () => {
  ...
  context("Borders special radius", () => {
  ...
  context("Borders corner radius", () => {

    it("TL Radius0", () => {
      cy.get("#tl-radius0").should("have.css", "border-top-left-radius", "0px");
    });
    it("TL Radius1", () => {
      cy.get("#tl-radius1").should("have.css", "border-top-left-radius", "4px");
    });
    it("TL Radius2", () => {
      cy
        .get("#tl-radius2")
  ...
  context("Borders line styles", () => {
    ...
    it("Border style top dash", () => {
      cy.get("#dasht").should("have.css", "border-top-style", "dashed");
    });
    it("Border style bottom dash", () => {
      cy.get("#dashb").should("have.css", "border-bottom-style", "dashed");
    });
    it("Border style left dash", () => {
      cy.get("#dashl").should("have.css", "border-left-style", "dashed");
    });
    it("Border style right dash", () => {
      cy.get("#dashr").should("have.css", "border-right-style", "dashed");
    });
    ...
    it("Border style top dot", () => {
      cy.get("#dott").should("have.css", "border-top-style", "dotted");
    });
    it("Border style bottom dot", () => {
      cy.get("#dotb").should("have.css", "border-bottom-style", "dotted");
    });
    it("Border style left dot", () => {
      cy.get("#dotl").should("have.css", "border-left-style", "dotted");
    });
    it("Border style right dot", () => {
      cy.get("#dotr").should("have.css", "border-right-style", "dotted");
    });
