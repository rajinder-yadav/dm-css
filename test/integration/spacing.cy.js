describe("Spacing", () => {
  ...
  context("Padding all", () => {
    ...
    it("All sides 3", () => {
      cy.get(".p3")
        .should("have.css", "padding-top", "10.48px")
        .should("have.css", "padding-bottom", "10.48px")
        .should("have.css", "padding-left", "10.48px")
        .should("have.css", "padding-right", "10.48px");
    });
    it("All sides 4", () => {
      cy.get(".p4")
        .should("have.css", "padding-top", "16.944px")
        .should("have.css", "padding-bottom", "16.944px")
        .should("have.css", "padding-left", "16.944px")
        .should("have.css", "padding-right", "16.944px");
    });
    it("All sides 5", () => {
      cy.get(".p5")
        .should("have.css", "padding-top", "27.424px")
        .should("have.css", "padding-bottom", "27.424px")
        .should("have.css", "padding-left", "27.424px")
        .should("have.css", "padding-right", "27.424px");
    });
    it("All sides 6", () => {
      cy.get(".p6")
        .should("have.css", "padding-top", "44.368px")
        .should("have.css", "padding-bottom", "44.368px")
        .should("have.css", "padding-left", "44.368px")
        .should("have.css", "padding-right", "44.368px");
    });
    it("All sides 7", () => {
      cy.get(".p7")
        .should("have.css", "padding-top", "71.776px")
        .should("have.css", "padding-bottom", "71.776px")
        .should("have.css", "padding-left", "71.776px")
        .should("have.css", "padding-right", "71.776px");
    });
    it("All sides 8", () => {
      cy.get(".p8")
        .should("have.css", "padding-top", "116.144px")
        .should("have.css", "padding-bottom", "116.144px")
        .should("have.css", "padding-left", "116.144px")
        .should("have.css", "padding-right", "116.144px");
    });
    it("All sides 9", () => {
      cy.get(".p9")
        .should("have.css", "padding-top", "187.92px")
        .should("have.css", "padding-bottom", "187.92px")
        .should("have.css", "padding-left", "187.92px")
        .should("have.css", "padding-right", "187.92px");
    });
    it("All sides 10", () => {
      cy.get(".p10")
        .should("have.css", "padding-top", "304.048px")
        .should("have.css", "padding-bottom", "304.048px")
        .should("have.css", "padding-left", "304.048px")
        .should("have.css", "padding-right", "304.048px");
    });
  });
  ...
  context("Margin all", () => {
    ...
    it("Margin all sides 3", () => {
      cy.get(".m3")
        .should("have.css", "margin-top", "10.48px")
        .should("have.css", "margin-bottom", "10.48px")
        .should("have.css", "margin-left", "10.48px")
        .should("have.css", "margin-right", "10.48px");
    });
    it("Margin all sides 4", () => {
      cy.get(".m4")
        .should("have.css", "margin-top", "16.944px")
        .should("have.css", "margin-bottom", "16.944px")
        .should("have.css", "margin-left", "16.944px")
        .should("have.css", "margin-right", "16.944px");
    });
    it("Margin all sides 5", () => {
      cy.get(".m5")
        .should("have.css", "margin-top", "27.424px")
        .should("have.css", "margin-bottom", "27.424px")
        .should("have.css", "margin-left", "27.424px")
        .should("have.css", "margin-right", "27.424px");
    });
    it("Margin all sides 6", () => {
      cy.get(".m6")
        .should("have.css", "margin-top", "44.368px")
        .should("have.css", "margin-bottom", "44.368px")
        .should("have.css", "margin-left", "44.368px")
        .should("have.css", "margin-right", "44.368px");
    });
    it("Margin all sides 7", () => {
      cy.get(".m7")
        .should("have.css", "margin-top", "71.776px")
        .should("have.css", "margin-bottom", "71.776px")
        .should("have.css", "margin-left", "71.776px")
        .should("have.css", "margin-right", "71.776px");
    });
    it("Margin all sides 8", () => {
      cy.get(".m8")
        .should("have.css", "margin-top", "116.144px")
        .should("have.css", "margin-bottom", "116.144px")
        .should("have.css", "margin-left", "116.144px")
        .should("have.css", "margin-right", "116.144px");
    });
    it("Margin all sides 9", () => {
      cy.get(".m9")
        .should("have.css", "margin-top", "187.92px")
        .should("have.css", "margin-bottom", "187.92px")
        .should("have.css", "margin-left", "187.92px")
        .should("have.css", "margin-right", "187.92px");
    });
    it("Margin all sides 10", () => {
      cy.get(".m10")
        .should("have.css", "margin-top", "304.048px")
        .should("have.css", "margin-bottom", "304.048px")
        .should("have.css", "margin-left", "304.048px")
        .should("have.css", "margin-right", "304.048px");
    });
  });
