...
![Version](https://img.shields.io/badge/dm--css-v2.1.2-blue.svg)
...
<html lang="en">
  <head>
    ...
    <!-- DM-CSS Toolkit -->
    <link href="https://cdn.jsdelivr.net/npm/dm-css@2.1.2/css/dm.min.css" rel="stylesheet">
  </head>
  <body>
...
Example usage for Dyno Might CSS version 2.1.2.
